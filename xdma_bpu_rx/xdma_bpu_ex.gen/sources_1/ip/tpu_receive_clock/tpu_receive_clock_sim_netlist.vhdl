...
-- Date        : Tue Jan  5 00:39:57 2021
-- Host        : ubuntu running 64-bit Ubuntu 18.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/caohy/Work/dual_line_process/xdma_bpu_rx/xdma_bpu_ex.gen/sources_1/ip/tpu_receive_clock/tpu_receive_clock_sim_netlist.vhdl
...
entity tpu_receive_clock_tpu_receive_clock_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of tpu_receive_clock_tpu_receive_clock_clk_wiz : entity is "tpu_receive_clock_clk_wiz";
end tpu_receive_clock_tpu_receive_clock_clk_wiz;

architecture STRUCTURE of tpu_receive_clock_tpu_receive_clock_clk_wiz is
  signal clk_in1_tpu_receive_clock : STD_LOGIC;
  signal clk_out1_tpu_receive_clock : STD_LOGIC;
  signal clk_out2_tpu_receive_clock : STD_LOGIC;
...
entity tpu_receive_clock is
  ...
  attribute NotValidForBitStream of tpu_receive_clock : entity is true;
end tpu_receive_clock;

architecture STRUCTURE of tpu_receive_clock is
begin
inst: entity work.tpu_receive_clock_tpu_receive_clock_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
