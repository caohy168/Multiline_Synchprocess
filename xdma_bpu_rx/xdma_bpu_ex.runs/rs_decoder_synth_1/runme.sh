...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_rx/xdma_bpu_ex.runs/rs_decoder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs_decoder.tcl
