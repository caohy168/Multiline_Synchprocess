...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_transmit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_transmit.tcl
