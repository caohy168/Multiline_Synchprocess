...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_rx/xdma_bpu_ex.runs/tpu_receive_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_receive_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_receive_clock.tcl
