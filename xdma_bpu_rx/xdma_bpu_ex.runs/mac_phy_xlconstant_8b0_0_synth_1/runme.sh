...
HD_PWD='/home/caohy/Work/xdma_bpu_tx/xdma_bpu_ex.runs/mac_phy_xlconstant_8b0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_phy_xlconstant_8b0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_phy_xlconstant_8b0_0.tcl
