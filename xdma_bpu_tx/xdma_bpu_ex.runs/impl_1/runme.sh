...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_transmit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tpu_transmit.tcl -notrace
