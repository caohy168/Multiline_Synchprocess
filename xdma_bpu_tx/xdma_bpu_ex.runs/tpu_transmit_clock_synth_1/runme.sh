...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.runs/tpu_transmit_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_transmit_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_transmit_clock.tcl
