...
HD_PWD='/home/caohy/Work/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.runs/rs_encoder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs_encoder.tcl
