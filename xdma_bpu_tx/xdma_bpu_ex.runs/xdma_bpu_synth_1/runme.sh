...
HD_PWD='/home/caohy168/Downloads/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.runs/xdma_bpu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xdma_bpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xdma_bpu.tcl
