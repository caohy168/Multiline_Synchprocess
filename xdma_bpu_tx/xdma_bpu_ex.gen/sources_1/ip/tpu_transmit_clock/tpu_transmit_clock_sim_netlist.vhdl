...
-- Date        : Tue Feb 23 22:49:15 2021
-- Host        : ubuntu running 64-bit Ubuntu 20.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/caohy/Work/dual_line_process/xdma_bpu_tx/xdma_bpu_ex.gen/sources_1/ip/tpu_transmit_clock/tpu_transmit_clock_sim_netlist.vhdl
...
entity tpu_transmit_clock_tpu_transmit_clock_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of tpu_transmit_clock_tpu_transmit_clock_clk_wiz : entity is "tpu_transmit_clock_clk_wiz";
end tpu_transmit_clock_tpu_transmit_clock_clk_wiz;

architecture STRUCTURE of tpu_transmit_clock_tpu_transmit_clock_clk_wiz is
  signal clk_in1_tpu_transmit_clock : STD_LOGIC;
  signal clk_out1_tpu_transmit_clock : STD_LOGIC;
  signal clk_out2_tpu_transmit_clock : STD_LOGIC;
  signal clkfbout_buf_tpu_transmit_clock : STD_LOGIC;
  signal clkfbout_tpu_transmit_clock : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => clkfbout_tpu_transmit_clock,
      O => clkfbout_buf_tpu_transmit_clock
    );
...
entity tpu_transmit_clock is
  ...
  attribute NotValidForBitStream of tpu_transmit_clock : entity is true;
end tpu_transmit_clock;

architecture STRUCTURE of tpu_transmit_clock is
begin
inst: entity work.tpu_transmit_clock_tpu_transmit_clock_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
