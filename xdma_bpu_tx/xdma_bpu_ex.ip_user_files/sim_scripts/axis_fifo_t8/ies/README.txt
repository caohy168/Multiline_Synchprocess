...
#
# Generated by export_simulation on Thu Dec 24 23:47:58 PST 2020
#
################################################################################
...
'-reset_run' switch to the './axis_fifo_t8.sh' script.

./axis_fifo_t8.sh -reset_run
...
./axis_fifo_t8.sh -noclean_files

For more information on the script, please type './axis_fifo_t8.sh -help'.
